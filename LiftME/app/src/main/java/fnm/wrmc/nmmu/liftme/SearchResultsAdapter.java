...
public class SearchResultsAdapter extends RecyclerView.Adapter<MatchedTripViewHolder>
{
    ...
    public void onBindViewHolder(MatchedTripViewHolder holder, int position) {
        ...
        holder.subTitle1.setText(String.format("%.2fkm from your pickup", trip.getDistanceBetweenPickups()));
        holder.subTitle2.setText(String.format("%.2fkm from your destination", trip.getDistanceBetweenDropOffs()));
    }
